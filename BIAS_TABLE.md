...
|---|------|-----------------|------------------|-------------------|
| 1 | **Survivorship (universe hole)** | **23%** of the top-500 (Jan-2015 vintage) no longer resolves on yfinance today: delisted, merged, suspended | Indian equities, 2015 to 2026 | Point-in-time 2015 top-500 mapped through renames to terminal symbols; batch-queried against yfinance; 2 Yahoo symbol quirks classified out |
